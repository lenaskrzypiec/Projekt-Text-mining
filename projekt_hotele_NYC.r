# ---
# "Analiza asocjacji oraz sentymentu recenzji hoteli w NYC"
...
data <- read.table("recenzje_hotele_NYC.csv",
...
key_aspects <- c("service", "staff", "room", "bed", "breakfast", "food", "comfort", "cleanliness", "location", "wifi", "pool", "price", "experience","stay")

# Próg korelacji Pearsona dla asocjacji.
cor_limit <- 0.4 # Znaleziony zalecany przedział dla recenzji 0,4-0,6
